...
The 16 cases cover valid STORE archives, a wrapped cursor that previously made
...
manifest buffer boundaries, and overflow-safe streaming reads. Fixture archives
